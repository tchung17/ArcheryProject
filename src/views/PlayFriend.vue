<template>
    <div class="container">
        ...
        <div class="button-container" v-else>
            ...
            >
                <el-button class="button" style="width: 100%;" type="primary" slot="reference" @click="generateCode()">
                Generate a New Code
            </el-button>
            </el-popover>
            <el-input style="margin-top: 10px;" placeholder="Enter your code" v-model="code"></el-input>
            <el-button
                class="button"
